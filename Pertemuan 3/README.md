# 📱 Pertemuan 3: Komponen UI Interaktif, Event Handling, & Material 3
...
![Mata Kuliah](https://img.shields.io/badge/PAM-Pertemuan%2003-green?style=for-the-badge)
...
Eksplorasi TextView, EditText, Button, ImageView, RadioButton, CheckBox, Spinner, penanganan event (OnClickListener), input validation, dan Material 3 styling.
...
1. Pemaparan konsep teori dan arsitektur materi Komponen UI Interaktif, Event Handling, & Material 3.
